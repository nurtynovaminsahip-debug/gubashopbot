...
def main():
    ...
    stars_recipient_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(h.cb_stars_recipient_other, pattern="^stars_recipient_other$")],
        states={
            states.STARS_RECIPIENT_INPUT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_stars_recipient_input)
            ]
        },
        fallbacks=[],
        per_chat=True, per_user=True, per_message=False,
    ...
    admin_settings_conv = ConversationHandler(
        entry_points=[
            ...
            CallbackQueryHandler(h.cb_admin_robux_group_rate_rub, pattern="^admin_robux_group_rate_rub$"),
            CallbackQueryHandler(h.cb_admin_robux_group_rate_stars, pattern="^admin_robux_group_rate_stars$"),
            CallbackQueryHandler(h.cb_admin_robux_group_link, pattern="^admin_robux_group_link$"),
        ],
        states={
            states.ADMIN_SETTINGS_STARS_RECIPIENT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_settings_recipient),
            ],
            states.ADMIN_ROBUX_GROUP_RATE_RUB: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_robux_group_rate_rub),
            ],
            states.ADMIN_ROBUX_GROUP_RATE_STARS: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_robux_group_rate_stars),
            ],
            states.ADMIN_ROBUX_GROUP_LINK: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_robux_group_link),
            ],
        },
        fallbacks=[CallbackQueryHandler(h.cb_admin_back, pattern="^admin_back$")],
        per_chat=True, per_user=True,
    ...
    app.add_handler(stars_recipient_conv)
    ...
    admin_top_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(h.cb_admin_top_add, pattern="^admin_top_add$")],
        states={
            states.ADMIN_TOP_ADD_NAME: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_top_name),
            ],
            states.ADMIN_TOP_ADD_SPENT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_top_spent),
            ],
            states.ADMIN_TOP_ADD_ORDERS: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, h.handle_admin_top_orders),
            ],
        },
        fallbacks=[CallbackQueryHandler(h.cb_admin_top_manage, pattern="^admin_top_manage$")],
        per_chat=True, per_user=True,
    )
    app.add_handler(admin_top_conv)
    ...
    app.add_handler(CallbackQueryHandler(h.cb_stars_recipient_me, pattern="^stars_recipient_me$"))
    ...
    app.add_handler(CallbackQueryHandler(h.cb_admin_top_manage, pattern="^admin_top_manage$"))
    app.add_handler(CallbackQueryHandler(h.cb_admin_top_remove, pattern=r"^admin_top_remove_\d+$"))
